...
public class MSB_JA_2 : StateMachineBehaviour
{
    ...
    private void CustomFunction(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        */
        ...
        // _playerMain._verticalVelocity = Mathf.Sqrt(1.5f * -2f * _playerMain.Gravity);// reset move and look direction, can be used in PlayerMain_A0 to control the character's movement and rotation
        _playerMain._combatSystem.DeactivateAllHitboxes(); _playerMain._combatSystem.ActivateAttack(0, 0, 0, 4);
        // vfx
        // sfx
    }
    ...
    public override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        _playerMain._anim_localMovingDirection = Vector3.zero;
