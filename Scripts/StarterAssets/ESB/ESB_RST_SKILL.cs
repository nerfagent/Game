...
public class ESB_RST_SKILL : StateMachineBehaviour
{
    ...
    private void CustomFunction(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        /*
            ...
            sfx
        */
        _playerMain._enemyDecision.curNextSkill = curNextSkill;
        _playerMain._animator.SetBool(_playerMain._enemyDecision._animIDActionLock, false);
        // other function
        // vfx
        // sfx
    }
